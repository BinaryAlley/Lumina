...
public class GetReadingSectionEndpointTests : IClassFixture<AuthenticatedLuminaApiFactory>, IAsyncLifetime
{
    ...
    public GetReadingSectionEndpointTests(AuthenticatedLuminaApiFactory apiFactory)
    {
    ...
    [Fact]
    public async Task GetReadingSection_WhenBookDoesNotExist_ShouldReturnBookNotFoundProblem()
    {
        // Act
    ...
    [Fact]
    public async Task GetReadingSection_WhenBookBelongsToAnotherUser_ShouldReturnForbidden()
    {
        // Arrange
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync($"/api/v1/books/{bookId}/reading/sections/chapter-1");
    ...
    [Fact]
    public async Task GetReadingSection_WhenBookBelongsToAnOwnedLibrary_ShouldNotLeakAnException()
    {
        // Arrange
    ...
    public async Task GetReadingSection_WhenUnauthorized_ShouldReturnUnauthorizedResult()
    {
        ...
        // Act
        HttpResponseMessage response = await unauthenticatedClient.GetAsync($"/api/v1/books/{Guid.NewGuid()}/reading/sections/chapter-1");
