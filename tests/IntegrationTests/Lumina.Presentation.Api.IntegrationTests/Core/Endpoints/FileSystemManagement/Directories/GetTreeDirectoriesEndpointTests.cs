...
public class GetTreeDirectoriesEndpointTests : IClassFixture<AuthenticatedLuminaApiFactory>, IAsyncLifetime
{
    ...
    public GetTreeDirectoriesEndpointTests(AuthenticatedLuminaApiFactory apiFactory)
    {
