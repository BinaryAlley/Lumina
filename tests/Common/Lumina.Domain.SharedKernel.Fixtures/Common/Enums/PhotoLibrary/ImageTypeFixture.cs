...
namespace Lumina.Domain.SharedKernel.Fixtures.Common.Enums.PhotoLibrary;

/// <summary>
/// Test-support class providing image byte data for each supported <see cref="ImageType"/>.
/// </summary>
