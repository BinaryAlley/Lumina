...
namespace Lumina.Application.Fixtures.Core.MediaLibrary.WrittenContentLibrary.BookLibrary.Books.Commands.AddBook;
...
public class AddBookCommandFixture
{
    ...
    /// <summary>
    /// Creates a list of <see cref="AddBookCommand"/>.
    /// </summary>
    /// <param name="count">The number of elements to create.</param>
    /// <returns>The created list.</returns>
    public List<AddBookCommand> CreateMany(int count = 3)
    {
