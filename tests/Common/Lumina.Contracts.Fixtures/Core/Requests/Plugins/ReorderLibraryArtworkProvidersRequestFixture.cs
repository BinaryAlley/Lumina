...
/// <summary>
/// Fixture class for the <see cref="ReorderLibraryArtworkProvidersRequest"/> record.
/// </summary>
...
public class ReorderLibraryArtworkProvidersRequestFixture
{
    ...
    /// <summary>
    /// Creates a random valid <see cref="ReorderLibraryArtworkProvidersRequest"/>.
    /// </summary>
    ...
    /// <returns>The created <see cref="ReorderLibraryArtworkProvidersRequest"/>.</returns>
    ...
    /// <summary>
    /// Creates a list of <see cref="ReorderLibraryArtworkProvidersRequest"/>.
    /// </summary>
