...
/// <summary>
/// Fixture class for the <see cref="StopScheduledJobRequest"/> class.
/// </summary>
[ExcludeFromCodeCoverage]
public class StopScheduledJobRequestFixture
{
    /// <summary>
    /// Creates a random valid request to stop the execution cycle of a scheduled job.
    /// </summary>
    ...
    {
        return new Faker<StopScheduledJobRequest>()
            .CustomInstantiator(f => new StopScheduledJobRequest(scheduledJobId ?? Guid.NewGuid()))
            .Generate();
    }

    /// <summary>
    /// Creates a list of <see cref="StopScheduledJobRequest"/>.
    /// </summary>
