...
namespace Lumina.Presentation.Web.SecurityTests.Common.Setup;

/// <summary>
/// Factory for creating the Web application for security tests, with the remote API client replaced by a configurable stub.
/// </summary>
