...
public class GetSchedulerDisplayPreferencesEndpointTests : IClassFixture<LuminaWebFactory>
{
    ...
    [Fact]
    public async Task GetSchedulerDisplayPreferences_WhenCalledWithoutAuthentication_ShouldRedirectToLogin()
    {
        // Arrange
        ...
        // Act
        HttpResponseMessage response = await client.GetAsync("/en-us/admin/api-scheduled-jobs/display-preferences");
    ...
    [Fact]
    public async Task GetSchedulerDisplayPreferences_WhenCalledByNonAdminUser_ShouldRedirectToAccessDenied()
    {
        // Arrange
        _apiFactory.ApiClientStub.Reset();
        ...
        // Act
        HttpResponseMessage response = await webClient.Client.GetAsync("/en-us/admin/api-scheduled-jobs/display-preferences");
    ...
    [Fact]
    public async Task GetSchedulerDisplayPreferences_WhenCalledByAdminUser_ShouldReturnDisplayPreferencesData()
    {
        // Arrange
        _apiFactory.ApiClientStub.Reset();
