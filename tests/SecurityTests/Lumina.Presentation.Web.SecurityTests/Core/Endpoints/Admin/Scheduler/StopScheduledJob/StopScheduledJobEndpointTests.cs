...
public class StopScheduledJobEndpointTests : IClassFixture<LuminaWebFactory>
{
    ...
    [Fact]
    public async Task StopScheduledJob_WhenCalledWithoutAntiforgeryToken_ShouldRejectRequest()
    {
        // Arrange
        _apiFactory.ApiClientStub.Reset();
        AuthenticatedWebClient webClient = await WebTestHelpers.CreateAuthenticatedClientAsync(_apiFactory);
        string url = $"/en-us/admin/api-scheduled-jobs/{Guid.NewGuid()}/stop";
    ...
    [Fact]
    public async Task StopScheduledJob_WhenCalledWithoutAuthentication_ShouldRedirectToLogin()
    {
        // Arrange
        _apiFactory.ApiClientStub.Reset();
