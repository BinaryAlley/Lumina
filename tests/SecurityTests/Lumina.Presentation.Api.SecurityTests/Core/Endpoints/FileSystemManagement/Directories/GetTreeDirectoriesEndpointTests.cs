...
/// <summary>
/// Contains security tests for the <c>/directories/get-tree-directories</c> route.
/// </summary>
...
public class GetTreeDirectoriesEndpointTests : IClassFixture<LuminaApiFactory>
{
    ...
    [Fact]
    public async Task GetTreeDirectories_WhenUnauthorized_ShouldReturnUnauthorizedResult()
    {
        // Act
        HttpResponseMessage response = await _client.GetAsync("/api/v1/directories/get-tree-directories");
        ...
        problemDetails["instance"].GetProperty("value").GetString().Should().Be("/api/v1/directories/get-tree-directories");
