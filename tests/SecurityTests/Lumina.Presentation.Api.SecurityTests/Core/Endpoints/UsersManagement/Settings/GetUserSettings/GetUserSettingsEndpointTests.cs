...
public class GetUserSettingsEndpointTests : IClassFixture<LuminaApiFactory>
{
    ...
    public GetUserSettingsEndpointTests(LuminaApiFactory apiFactory)
    {
    ...
    [Fact]
    public async Task GetUserSettings_WhenAuthenticated_ShouldNotLeakSensitiveData()
    {
        // Arrange
        ...
        // Act
        HttpResponseMessage response = await client.GetAsync("/api/v1/users/me/settings");
