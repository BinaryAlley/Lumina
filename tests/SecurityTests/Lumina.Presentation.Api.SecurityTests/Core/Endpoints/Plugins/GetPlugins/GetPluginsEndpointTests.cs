...
public class GetPluginsEndpointTests : IClassFixture<LuminaApiFactory>
{
    ...
    public GetPluginsEndpointTests(LuminaApiFactory apiFactory)
    {
        _client = apiFactory.CreateClient();
    }

    [Fact]
    public async Task GetPlugins_WhenUnauthorized_ShouldReturnUnauthorizedResult()
    {
        // Act
        ...
        Assert.Equal("/api/v1/plugins", problemDetails["instance"].GetProperty("value").GetString());
