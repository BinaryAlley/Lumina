...
/// <summary>
/// Contains security tests for the <see cref="GetPermissionsEndpoint"/> class.
/// </summary>
...
public class GetPermissionsEndpointTests : IClassFixture<LuminaApiFactory>
{
    ...
    public async Task GetPermissions_WhenUnauthorized_ShouldReturnUnauthorizedResult()
    {
        ...
        Assert.Equal("/api/v1/auth/permissions", problemDetails["instance"].GetProperty("value").GetString());
