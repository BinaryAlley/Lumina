...
namespace Lumina.Presentation.Api.SecurityTests.Core.Endpoints.Library.Management.CancelLibrariesScan;

/// <summary>
/// Contains security tests for the <c>/libraries/scans/cancel</c> route.
/// </summary>
[ExcludeFromCodeCoverage]
public class CancelLibrariesScanEndpointTests : IClassFixture<LuminaApiFactory>
{
    ...
    public CancelLibrariesScanEndpointTests(LuminaApiFactory apiFactory)
    {
    ...
    [Fact]
    public async Task CancelLibrariesScan_WhenUnauthorized_ShouldReturnUnauthorizedResult()
    {
        // Act
        ...
        Assert.Equal("/api/v1/libraries/scans/cancel", problemDetails["instance"].GetProperty("value").GetString());
        Assert.Equal("Authentication failed", problemDetails["detail"].GetString());
    }

    [Fact]
    public async Task CancelLibrariesScan_WhenAuthenticated_ShouldNotLeakSensitiveData()
    {
        // Arrange
        ...
        // Act
        HttpResponseMessage response = await client.PostAsJsonAsync("/api/v1/libraries/scans/cancel", new { });
