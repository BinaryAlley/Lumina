...
namespace Lumina.Presentation.Api.SecurityTests.Core.Endpoints.Library.Management.GetLibraries;

/// <summary>
/// Contains security tests for the <see cref="GetLibrariesEndpoint"/> class.
/// </summary>
[ExcludeFromCodeCoverage]
public class GetLibrariesEndpointTests : IClassFixture<LuminaApiFactory>
{
    ...
    public GetLibrariesEndpointTests(LuminaApiFactory apiFactory)
    {
    ...
    [Fact]
    public async Task GetLibraries_WhenUnauthorized_ShouldReturnUnauthorizedResult()
    {
        // Act
    ...
    [Fact]
    public async Task GetLibraries_WhenAuthenticated_ShouldNotLeakSensitiveData()
    {
        // Arrange
        ...
        // Act
        HttpResponseMessage response = await client.GetAsync("/api/v1/libraries");
