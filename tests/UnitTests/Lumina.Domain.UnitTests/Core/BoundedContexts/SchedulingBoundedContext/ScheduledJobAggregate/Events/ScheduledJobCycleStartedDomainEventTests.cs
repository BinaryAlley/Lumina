...
/// <summary>
/// Contains unit tests for the <see cref="ScheduledJobCycleStartedDomainEvent"/> class.
/// </summary>
[ExcludeFromCodeCoverage]
public class ScheduledJobCycleStartedDomainEventTests
{
    ...
    public void Constructor_WhenCalled_ShouldSetAllProperties()
    {
        ...
        // Act
        ScheduledJobCycleStartedDomainEvent domainEvent = _scheduledJobCycleStartedDomainEventFixture.Create(id, scheduledJobId, occurredOnUtc);
