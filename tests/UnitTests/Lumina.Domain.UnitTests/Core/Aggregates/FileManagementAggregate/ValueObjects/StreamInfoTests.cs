...
public class StreamInfoTests
{
    ...
    public void Create_WithNullStreamId_ShouldReturnError()
    {
        ...
        result.FirstError.Should().Be(Errors.FileManagement.StreamIdCannotBeEmpty);
    }
    ...
    public void Create_WithNullCodec_ShouldReturnError()
    {
        ...
        // Assert
        result.IsError.Should().BeTrue();
        result.FirstError.Should().Be(Errors.FileManagement.CodecCannotBeEmpty);
    }
    ...
    public void Create_WithNonPositiveBitrate_ShouldReturnError()
    {
        ...
        // Assert
        result.IsError.Should().BeTrue();
        result.FirstError.Should().Be(Errors.FileManagement.BitrateMustBeAPositiveNumber);
    }
