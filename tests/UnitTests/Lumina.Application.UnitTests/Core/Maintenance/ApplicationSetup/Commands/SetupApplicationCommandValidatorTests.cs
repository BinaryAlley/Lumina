...
using Lumina.Application.UnitTests.Core.Maintenance.ApplicationSetup.Commands.Fixtures;
using Lumina.Application.Common.Errors;
using System.Diagnostics.CodeAnalysis;
#endregion

namespace Lumina.Application.UnitTests.Core.Maintenance.ApplicationSetup.Commands;
...
public class SetupApplicationCommandValidatorTests
{
    ...
    {
        // Arrange
        SetupApplicationCommand command = SetupApplicationCommandFixture.CreateSetupApplicationCommand();
