...
public class AddBookCommandHandlerTests
{
    ...
    public async Task Handle_WhenCalledWithValidCommand_ShouldReturnSuccessResult()
    {
        ...
        _mockMapper.Map<BookDto>(Arg.Any<Book>()).Returns(bookDto);
        _mockBookRepository.InsertAsync(Arg.Any<BookDto>(), Arg.Any<CancellationToken>())
        ...
        await _mockBookRepository.Received(1).InsertAsync(Arg.Any<BookDto>(), Arg.Any<CancellationToken>());
    ...
    public async Task Handle_WhenBookCreationFails_ShouldReturnFailureResult()
    {
        ...
        await _mockBookRepository.DidNotReceive().InsertAsync(Arg.Any<BookDto>(), Arg.Any<CancellationToken>());
