...
public class GetPluginSettingsQueryHandlerTests
{
    ...
    public GetPluginSettingsQueryHandlerTests()
    {
        ...
        _sut = new GetPluginSettingsQueryHandler(_mockUnitOfWork, _mockPluginManager);
    }
    ...
    public async Task HandleAsync_WhenPluginIsLoaded_ShouldReturnSchemaAndSettings()
    {
        ...
        [
            new PluginSettingDescriptorDto("key1", "Label 1", PluginSettingType.Text, "default"),
            new PluginSettingDescriptorDto("key2", "Label 2", PluginSettingType.Select, null, ["a", "b"])
        ]);
