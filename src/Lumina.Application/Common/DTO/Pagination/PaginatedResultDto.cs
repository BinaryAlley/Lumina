...
namespace Lumina.Application.Common.DTO.Pagination;

/// <summary>
/// Represents a paginated result containing a subset of data and pagination metadata for the current page.
/// </summary>
/// <typeparam name="TData">The type of the data items contained in the paginated result.</typeparam>
public sealed record PaginatedResultDto<TData>
{
    /// <summary>
