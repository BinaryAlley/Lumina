...
/// <summary>
/// Represents a filter specification that combines two filter specifications using a logical OR operation.
/// </summary>
/// <typeparam name="T">The type of entity to which the filter specification is applied.</typeparam>
internal class OrFilterSpecification<T> : FilterSpecification<T>
{
