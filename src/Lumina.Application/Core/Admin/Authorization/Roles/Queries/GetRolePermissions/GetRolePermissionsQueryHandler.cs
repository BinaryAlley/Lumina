...
public class GetRolePermissionsQueryHandler : IQueryHandler<GetRolePermissionsQuery, Result<RolePermissionsResponse>>
{
    ...
    private readonly IValidator<GetRolePermissionsQuery> _validator;
    ...
    public GetRolePermissionsQueryHandler(IAuthorizationService authorizationService, ICurrentUserService currentUserService, IUnitOfWork unitOfWork, IValidator<GetRolePermissionsQuery> validator)
    {
