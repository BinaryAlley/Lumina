...
/// <summary>
/// Handler for the query to get a resource of a book, for reading.
/// </summary>
public class GetReadingResourceQueryHandler : IQueryHandler<GetReadingResourceQuery, Result<ReadingResourceDataDto>>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IAuthorizationService _authorizationService;
    private readonly ICurrentUserService _currentUserService;
    private readonly IBookReadingService _bookReadingService;
    private readonly IValidator<GetReadingResourceQuery> _validator;

    /// <summary>
    /// Initializes a new instance of the <see cref="GetReadingResourceQueryHandler"/> class.
    /// </summary>
    ...
    public GetReadingResourceQueryHandler(IUnitOfWork unitOfWork, IAuthorizationService authorizationService, ICurrentUserService currentUserService, IBookReadingService bookReadingService, IValidator<GetReadingResourceQuery> validator)
    {
    ...
    /// <summary>
    /// Handles the query to get a resource of a book, for reading.
    /// </summary>
    /// <param name="query">The query to be handled.</param>
    /// <param name="cancellationToken">Cancellation token that can be used to stop the execution.</param>
    /// <returns>
    /// An <see cref="Result{TValue}"/> containing either the resource of the book, or an error.
    /// </returns>
    public async Task<Result<ReadingResourceDataDto>> HandleAsync(GetReadingResourceQuery query, CancellationToken cancellationToken)
    {
