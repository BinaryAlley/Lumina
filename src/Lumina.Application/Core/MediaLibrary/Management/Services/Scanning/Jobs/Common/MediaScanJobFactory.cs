...
/// </summary>
internal class MediaScanJobFactory : IMediaScanJobFactory
{
    private readonly IServiceProvider _serviceProvider;

    /// <summary>
    /// Initializes a new instance of the <see cref="MediaScanJobFactory"/> class.
    /// </summary>
    /// <param name="serviceProvider">The service provider.</param>
    public MediaScanJobFactory(IServiceProvider serviceProvider)
    {
    ...
    public TJob CreateJob<TJob>(Library library) where TJob : MediaScanJob
    {
