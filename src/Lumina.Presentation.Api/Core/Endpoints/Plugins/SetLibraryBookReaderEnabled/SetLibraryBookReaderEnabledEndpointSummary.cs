...
/// <summary>
/// Class used for providing a textual description for the <see cref="SetLibraryBookReaderEnabledEndpoint"/> API endpoint, for OpenAPI.
/// </summary>
[ExcludeFromCodeCoverage]
public class SetLibraryBookReaderEnabledEndpointSummary : Summary<SetLibraryBookReaderEnabledEndpoint, SetLibraryBookReaderEnabledRequest>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SetLibraryBookReaderEnabledEndpointSummary"/> class.
    /// </summary>
    public SetLibraryBookReaderEnabledEndpointSummary()
    {
        Summary = "Enables or disables a book reader for a media library.";
        Description = "Enables or disables the book reader of the media library identified by the request.";

        ExampleRequest = new SetLibraryBookReaderEnabledRequest(
        ...
        RequestParam(r => r.IsEnabled, "Whether the book reader should be enabled for the media library. Required.");

        Response(200, "The book reader of the media library is enabled or disabled.",
            example: new
            {
                success = true
            }
