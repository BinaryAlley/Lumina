...
/// <summary>
/// Class used for providing a textual description for the <see cref="ReorderLibraryMetadataProvidersEndpoint"/> API endpoint, for OpenAPI.
/// </summary>
[ExcludeFromCodeCoverage]
public class ReorderLibraryMetadataProvidersEndpointSummary : Summary<ReorderLibraryMetadataProvidersEndpoint, ReorderLibraryMetadataProvidersRequest>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ReorderLibraryMetadataProvidersEndpointSummary"/> class.
    /// </summary>
    public ReorderLibraryMetadataProvidersEndpointSummary()
    {
        Summary = "Reorders the metadata providers of a media library.";
        Description = "Reorders the metadata providers of a media library, determining the order in which the providers are tried during the metadata enrichment of the library scans.";
        ...
        Response(200, "The metadata providers of the media library were successfully reordered.");
        ...
        Response(401, "Authentication required.", "application/problem+json",
            example: new[]
            {
                new
                {
                    ...
                    instance = "/api/v1/libraries/{libraryId}/metadata-providers/reorder"
                },
                new
                {
                    type = "https://tools.ietf.org/html/rfc7235#section-3.1",
