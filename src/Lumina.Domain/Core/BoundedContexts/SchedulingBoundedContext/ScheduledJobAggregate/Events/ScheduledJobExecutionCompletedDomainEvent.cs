...
/// <summary>
/// Domain event raised when the task of a scheduled job completes its execution.
/// </summary>
/// <param name="Id">The unique identifier of the domain event.</param>
/// <param name="ScheduledJobId">The unique identifier of the scheduled job whose task completed its execution.</param>
...
/// <param name="CompletedOnUtc">The date and time when the execution completed.</param>
[DebuggerDisplay("Id: {ScheduledJobId.Value}, RunId: {RunId}")]
public record ScheduledJobExecutionCompletedDomainEvent(
    Guid Id,
...
) : IDomainEvent
{
    ...
    /// </summary>
    public DateTime OccurredOnUtc => CompletedOnUtc;
}
