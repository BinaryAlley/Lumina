...
/// <summary>
/// Domain event raised when the execution cycle of a scheduled job is started.
/// </summary>
/// <param name="Id">The unique identifier of the domain event.</param>
/// <param name="ScheduledJobId">The unique identifier of the scheduled job whose execution cycle was started.</param>
/// <param name="OccurredOnUtc">The date and time when the domain event occurred.</param>
[DebuggerDisplay("Id: {ScheduledJobId.Value}")]
public record ScheduledJobCycleStartedDomainEvent(
    Guid Id,
