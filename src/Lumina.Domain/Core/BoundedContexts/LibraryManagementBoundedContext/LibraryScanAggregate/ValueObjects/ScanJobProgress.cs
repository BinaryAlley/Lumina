...
public sealed class ScanJobProgress : ValueObject
{
    /// <summary>
    ...
    /// </summary>
    public decimal ProgressPercentage => CompletedItems * 100.0m / TotalItems;

    /// <summary>
    /// Initializes a new instance of the <see cref="ScanJobProgress"/> class.
    /// </summary>
    ...
    private ScanJobProgress(int completedItems, int totalItems, string currentOperation)
    {
    ...
    /// <summary>
    /// Creates a new instance of the <see cref="ScanJobProgress"/> class.
    /// </summary>
    /// <param name="completedItems">The number of completed items of the media library scan job.</param>
    /// <param name="totalItems">The total number of items of the media library scan job.</param>
    /// <param name="currentOperation">The current operation being performed by the media library scan job.</param>
    /// <returns>
    /// An <see cref="ErrorOr{TValue}"/> containing either a successfuly created <see cref="ScanJobProgress"/>, or an error message.
    /// </returns>
    public static ErrorOr<ScanJobProgress> Create(int completedItems, int totalItems, string currentOperation)
    {
        if (totalItems <= 0)
        ...
        return new ScanJobProgress(completedItems, totalItems, currentOperation);
    }
