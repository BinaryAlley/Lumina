...
public interface IDirectoryProviderService
{
    ...
    Result<bool> DirectoryExists(FileSystemPathId path);
    ...
    Result<FileSystemPathId> CreateDirectory(FileSystemPathId path, string name);
    ...
    Result<FileSystemPathId> RenameDirectory(FileSystemPathId path, string name);
    ...
    Result<Deleted> DeleteDirectory(FileSystemPathId path);
}
