...
public interface IFileService
{
    ...
    Result<IEnumerable<File>> GetFiles(string path, bool includeHiddenElements);
    ...
    /// <param name="includeHiddenElements">Whether to include hidden files or not.</param>
    /// <returns>An <see cref="Result{TValue}"/> containing either a collection of files or an error.</returns>
    Result<IEnumerable<File>> GetFiles(File file, bool includeHiddenElements);
    ...
    /// <param name="includeHiddenElements">Whether to include hidden files or not.</param>
    /// <returns>An <see cref="Result{TValue}"/> containing either a collection of files or an error.</returns>
    Result<IEnumerable<File>> GetFiles(FileSystemPathId path, bool includeHiddenElements);
    ...
    Result<File> CopyFile(string sourcePath, string destinationPath, bool? overrideExisting);
    ...
    Result<File> MoveFile(string sourcePath, string destinationPath, bool? overrideExisting);
    ...
    /// <returns>An <see cref="Result{TValue}"/> containing either a renamed file, or an error.</returns>
    Result<File> RenameFile(string path, string name);
    ...
    Result<Deleted> DeleteFile(string path);
}
