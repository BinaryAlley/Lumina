...
public interface IDirectoryService
{
    ...
    /// <returns>An <see cref="Result{TValue}"/> containing either a created directory, or an error.</returns>
    Result<Directory> CreateDirectory(string path, string name);
    ...
    /// <returns>An <see cref="Result{TValue}"/> containing either a renamed directory, or an error.</returns>
    Result<Directory> RenameDirectory(string path, string name);
    ...
    Result<Deleted> DeleteDirectory(string path);
}
