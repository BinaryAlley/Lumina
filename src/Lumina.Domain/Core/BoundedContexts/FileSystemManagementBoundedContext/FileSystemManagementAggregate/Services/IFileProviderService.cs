...
public interface IFileProviderService
{
    ...
    Result<byte[]> GetFileAsync(FileSystemPathId path);
    ...
    Result<bool> FileExists(FileSystemPathId path);
    ...
    Result<string> GetFileName(FileSystemPathId path);
    ...
    Result<Optional<DateTime>> GetLastWriteTime(FileSystemPathId path);
    ...
    /// <returns>An <see cref="Result{TValue}"/> containing either the otional creation time of <paramref name="path"/> if available, or an error.</returns>
    Result<Optional<DateTime>> GetCreationTime(FileSystemPathId path);
    ...
    Result<long?> GetSize(FileSystemPathId path);
    ...
    Result<FileSystemPathId> RenameFile(FileSystemPathId path, string name);
    ...
    Result<Deleted> DeleteFile(FileSystemPathId path);
}
