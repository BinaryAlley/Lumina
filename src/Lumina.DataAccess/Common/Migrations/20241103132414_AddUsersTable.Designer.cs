...
namespace Lumina.DataAccess.Common.Migrations
{
    ...
    [Migration("20241103132414_AddUsersTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lumina.Application.Common.DataAccess.Entities.WrittenContentLibrary.BookLibrary.BookEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("BookGenres", b =>
                {
                    b.HasOne("Lumina.Application.Common.DataAccess.Entities.WrittenContentLibrary.BookLibrary.BookEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Lumina.Application.Common.DataAccess.Entities.WrittenContentLibrary.BookLibrary.BookEntity", b =>
                {
                    b.OwnsMany("Lumina.Application.Common.DataAccess.Entities.WrittenContentLibrary.BookLibrary.BookRatingEntity", "Ratings", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("INTEGER");
                    ...
                    b.OwnsMany("Lumina.Application.Common.DataAccess.Entities.WrittenContentLibrary.BookLibrary.IsbnEntity", "ISBNs", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("INTEGER");
