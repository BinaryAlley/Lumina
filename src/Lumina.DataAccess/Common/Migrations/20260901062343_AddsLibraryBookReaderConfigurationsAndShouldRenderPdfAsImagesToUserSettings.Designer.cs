...
namespace Lumina.DataAccess.Common.Migrations
{
    ...
    [Migration("20260901062343_AddsLibraryBookReaderConfigurationsAndShouldRenderPdfAsImagesToUserSettings")]
    partial class AddsLibraryBookReaderConfigurationsAndShouldRenderPdfAsImagesToUserSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lumina.Application.Common.DataAccess.Entities.UsersManagement.UserSettingsEntity", b =>
                {
                    ...
                    b.Property<bool>("IsThemeCachingEnabled")
                        .HasColumnType("INTEGER")
                        .HasColumnOrder(9);
