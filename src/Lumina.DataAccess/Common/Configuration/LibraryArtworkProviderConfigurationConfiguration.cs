...
/// <summary>
/// Configures the entity mapping for the <see cref="LibraryArtworkProviderConfigurationEntity"/> entity.
/// </summary>
public class LibraryArtworkProviderConfigurationConfiguration : IEntityTypeConfiguration<LibraryArtworkProviderConfigurationEntity>
{
    /// <summary>
    /// Configures the <see cref="LibraryArtworkProviderConfigurationEntity"/> entity.
    /// </summary>
    /// <param name="builder">The builder to be used to configure the entity.</param>
    public void Configure(EntityTypeBuilder<LibraryArtworkProviderConfigurationEntity> builder)
    {
        builder.ToTable("LibraryArtworkProviderConfigurations");
