...
/// <summary>
/// Data transfer object for a media library scan progress model.
/// </summary>
[DebuggerDisplay("ScanId: {ScanId}; UserId: {UserId}; LibraryId: {LibraryId}")]
public class LibraryScanProgressDto
{
    /// <summary>
    ...
    /// </summary>
    public LibraryScanJobProgressDto? CurrentJobProgress { get; set; }
