...
public static class ValidatorUtilities
{
    ...
    /// <summary>
    /// Defines a validation rule that ensures the long property is greater than the specified value.
    /// </summary>
    /// <typeparam name="TRequest">The type of the request being validated.</typeparam>
    /// <param name="ruleBuilder">The rule builder instance.</param>
    /// <param name="valueToCompare">The value that the property must be greater than.</param>
    /// <returns>The current <see cref="IRuleBuilder{TRequest, TProperty}"/> instance for method chaining.</returns>
    public static IRuleBuilder<TRequest, long> GreaterThan<TRequest>(this IRuleBuilder<TRequest, long> ruleBuilder, long valueToCompare)
    {
        return ruleBuilder.Must(value => value > valueToCompare);
    }

    /// <summary>
    /// Defines a validation rule that ensures the nullable long property is greater than the specified value.
    /// </summary>
    /// <remarks>
    /// If the property is <see langword="null"/>, this rule passes (use <see cref="NotNull{TRequest, TProperty}(IRuleBuilder{TRequest, TProperty})"/> to check for missing values).
    /// </remarks>
    ...
    /// <summary>
    /// Defines a validation rule that ensures the unsigned short property is within the specified inclusive range.
    /// </summary>
    /// <typeparam name="TRequest">The type of the request being validated.</typeparam>
    /// <param name="ruleBuilder">The rule builder instance.</param>
    /// <param name="minimumValue">The minimum allowed value of the property.</param>
    /// <param name="maximumValue">The maximum allowed value of the property.</param>
    /// <returns>The current <see cref="IRuleBuilder{TRequest, TProperty}"/> instance for method chaining.</returns>
    public static IRuleBuilder<TRequest, ushort> InclusiveBetween<TRequest>(this IRuleBuilder<TRequest, ushort> ruleBuilder, ushort minimumValue, ushort maximumValue)
    {
        return ruleBuilder.Must(value => value >= minimumValue && value <= maximumValue);
    }

    /// <summary>
    /// Defines a validation rule that ensures the character property is within the specified inclusive range.
    /// </summary>
    /// <typeparam name="TRequest">The type of the request being validated.</typeparam>
    /// <param name="ruleBuilder">The rule builder instance.</param>
    /// <param name="minimumValue">The minimum allowed value of the property.</param>
    /// <param name="maximumValue">The maximum allowed value of the property.</param>
    /// <returns>The current <see cref="IRuleBuilder{TRequest, TProperty}"/> instance for method chaining.</returns>
    public static IRuleBuilder<TRequest, char> InclusiveBetween<TRequest>(this IRuleBuilder<TRequest, char> ruleBuilder, char minimumValue, char maximumValue)
    {
        return ruleBuilder.Must(value => value >= minimumValue && value <= maximumValue);
    }

    /// <summary>
    /// Defines a validation rule that ensures the long property is within the specified inclusive range.
    /// </summary>
    /// <typeparam name="TRequest">The type of the request being validated.</typeparam>
    /// <param name="ruleBuilder">The rule builder instance.</param>
    /// <param name="minimumValue">The minimum allowed value of the property.</param>
    /// <param name="maximumValue">The maximum allowed value of the property.</param>
    /// <returns>The current <see cref="IRuleBuilder{TRequest, TProperty}"/> instance for method chaining.</returns>
    public static IRuleBuilder<TRequest, long> InclusiveBetween<TRequest>(this IRuleBuilder<TRequest, long> ruleBuilder, long minimumValue, long maximumValue)
    {
        return ruleBuilder.Must(value => value >= minimumValue && value <= maximumValue);
    }
