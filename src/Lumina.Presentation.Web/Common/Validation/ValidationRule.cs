...
/// <summary>
/// Defines a validation rule that evaluates a specific property of an instance.
/// </summary>
/// <typeparam name="TRequest">The type of the instance being validated.</typeparam>
/// <typeparam name="TProperty">The type of the specific property on the instance that the rule applies to.</typeparam>
