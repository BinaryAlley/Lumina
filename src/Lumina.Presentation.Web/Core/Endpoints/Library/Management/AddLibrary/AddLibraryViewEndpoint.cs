...
/// <summary>
/// API endpoint for the <c>/{culture}/libraries/manage/item</c> route.
/// </summary>
public class AddLibraryViewEndpoint : BaseEndpoint<EmptyRequest, IResult>
{
    /// <summary>
    ...
    public override void Configure()
    {
        base.Configure();
        Verbs(Http.GET);
        Routes(WebRoutes.LibraryManagement.ADD_LIBRARY);
        DontAutoTag();
        Options(options => options.WithTags("Libraries"));
    }

    /// <summary>
    /// Displays the media library adding view.
    /// </summary>
    ...
    public override Task<IResult> ExecuteAsync(EmptyRequest request, CancellationToken cancellationToken)
    {
        ...
        return Task.FromResult(View("/Core/Views/Library/Management/Item.cshtml", library));
    }
}
