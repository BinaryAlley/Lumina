...
/// <summary>
/// API endpoint for the <c>/{culture}/admin/manage-roles</c> route.
/// </summary>
public class ManageRolesViewEndpoint : BaseEndpoint<EmptyRequest, IResult>
{
    private readonly IApiHttpClient _apiHttpClient;

    /// <summary>
    /// Initializes a new instance of the <see cref="ManageRolesViewEndpoint"/> class.
    /// </summary>
    /// <param name="apiHttpClient">Injected service for interactions with the API.</param>
    public ManageRolesViewEndpoint(IApiHttpClient apiHttpClient)
    {
    ...
    public override void Configure()
    {
        base.Configure();
        Verbs(Http.GET);
        Routes(WebRoutes.Admin.MANAGE_ROLES);
        DontAutoTag();
    ...
    /// <summary>
    /// Displays the authorization roles management view.
    /// </summary>
    ...
    public override async Task<IResult> ExecuteAsync(EmptyRequest request, CancellationToken cancellationToken)
    {
        ...
        Dictionary<string, object?> viewData = new() { ["roles"] = roles, ["permissions"] = permissions };
        return View("/Core/Views/Admin/ManageRoles.cshtml", viewData: viewData);
    }
}
